...
public class JumblrClient {
  ...
  public List<Post> blogSubmissions(String blogName, Map<String, ?> options) {
    return requestBuilder.get(JumblrClient.blogPath(blogName, "/posts/submission"), options)
        .getPosts();
  }
  ...
  public Post postReblog(String blogName, Long postId, String reblogKey, Map<String, ?> options) {
    ...
    final Long reblogId =
        requestBuilder.post(JumblrClient.blogPath(blogName, "/post/reblog"), soptions).getId();
