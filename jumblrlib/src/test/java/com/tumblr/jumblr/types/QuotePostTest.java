...
public class QuotePostTest extends TypeTest {
  ...
  private String notes =
      "[{\"timestamp\":12345,\"blog_name\":\"bloggy\",\"blog_url\":\"bloggy_url\",\"type\":\"reblog_type\",\"post_id\":54321}]";
  ...
  @Test public void testWriters() {
    post.setSource("test_source");
    assertEquals("test_source", post.getSource());
    post.setText("test_text");
    assertEquals("test_text", post.getText());
  }
