...
public class BlogTest extends TypeTest {
  ...
  @Test public void getPost() {
    blog.getPost(42L);
    verify(client).blogPost(name, 42L);
  }

  @Test public void getLikedPosts() {
    blog.likedPosts();
  ...
  @Test public void getFollow() {
    blog.follow();
    verify(client).follow(name);
  }

  @Test public void getUnfollow() {
    blog.unfollow();
    verify(client).unfollow(name);
  }

  @Test public void queuedPosts() {
    blog.queuedPosts();
