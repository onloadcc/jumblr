...
public class JumblrClientTest {
  ...
  @Test public void userDashboard() {
  ...
  @Test public void userFollowing() {
  ...
  @Test public void blogFollowers() {
  ...
  @Test public void blogQueuedPosts() {
  ...
  @Test public void blogDraftPosts() {
  ...
  @Test public void blogSubmissions() {
  ...
  @Test public void postEdit() throws IOException {
    Map<String, Object> options = getRandomishOptions();
  ...
  @Test public void postCreate() throws IOException {
    Map<String, Object> options = getRandomishOptions();
